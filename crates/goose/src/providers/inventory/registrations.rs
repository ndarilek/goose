...
use crate::providers::gemini_acp::{GEMINI_ACP_DEFAULT_BINARY, GEMINI_ACP_PROVIDER_NAME};
...
pub fn gemini_acp_inventory() -> InventoryRegistration {
    acp_inventory(GEMINI_ACP_PROVIDER_NAME, GEMINI_ACP_DEFAULT_BINARY, true)
}
